...
{
    public partial class iscrizione : IDataErrorInfo
    {
            ...
            get
            {
                ...
                if (columnName == "Data")
                {
                    ...
                    if (DateTime.TryParse(Data.ToString(), out date_time) == false
                        || Data == null)
                        result = "La Data dell'iscrizione è un campo obbligatorio.";
                }
                return result;
        ...
        public bool IsValid
        {
            ...
            {
                DateTime date_time;
                if (this.Data == null || DateTime.TryParse(Data.ToString(), out date_time) == false) return false;
